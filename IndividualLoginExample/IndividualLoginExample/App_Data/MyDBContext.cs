...
namespace IndividualLoginExample
{
    public class MyDBContext : DbContext
    {
        ...
        public ObjectResult<Role> GetRoles(int? id = null, string roleName = null, int? rowsToSkip = 0, int? rowsToTake = 5)
        {
        ...
        public List<Role> GetRoles(ref int totalRecords, int? id = null, string roleName = null, int? rowsToSkip = 0, int? rowsToTake = 5)
        {
            totalRecords = 0;

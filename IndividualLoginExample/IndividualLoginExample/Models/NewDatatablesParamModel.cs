...
{
    /// <summary>
    /// Model class(es) containing properties for all parameters sent to the server by the Jquery datatables plugin
    /// Implemented from Stack Overflow 
    /// http://stackoverflow.com/a/28223358
    /// The model is also binded from the raw format by DataTablesParamsModelBinder also implemented from the same source
    /// </summary>

    public class NewDatatablesParamModel
    {
        /// <summary>
